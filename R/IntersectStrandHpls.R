...
{ if(length(nrFW)!= length(hseqsFW)) stop("The length of the sequences and the counts must be equal \n")
  if(length(nrRV)!= length(hseqsRV)) stop("The length of the sequences and the counts must be equal \n")
